...
# on peut mettre du texte dans le Div, mais on peut aussi mettre du html et du css
...
# le app.layout crée un objet python. On peut donc le mettre dans une liste

titres = [html.H1("First Dash app"), html.H3("Bruxelles Formation 2024")]
app.layout = html.Div(titres)

# BIEN REGARDER le dash core components
